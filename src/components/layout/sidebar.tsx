...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 flex flex-col">
      <div className="flex items-center gap-2 px-6 py-5 border-b border-gray-200 dark:border-gray-700">
        ...
        <span className="text-xl font-bold text-gray-900 dark:text-white">ChatsFunnels</span>
      </div>
